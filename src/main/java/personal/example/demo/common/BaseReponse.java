...
public class BaseReponse<T> {
  ...
  public static <T> BaseReponse<T> unauthorized(String message) {
    return new BaseReponse<>(HttpStatus.UNAUTHORIZED.value(), message, null);
  }

  public static <T> BaseReponse<T> badRequest(String message) {
